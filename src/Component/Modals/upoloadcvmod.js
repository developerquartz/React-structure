...
export default function Upoloadcvmod(props) {
      ...
      <Modal.Body>
        <div className="modal_uploadcv_inner position-relative">
          ...
          <div className="modal_uploadcv_confimation text-center">
            ...
            <p>
              Thank you for expressing your interest in joining Us. We
              appreciate the time and effort you invested in applying for the
              Customer services position.
            </p>

            <p>Our team will carefully review your application. </p>

            <Button className="view_allcta w-100" onClick={() => navigate("/careers")}>Done</Button>
          </div>
        </div>
      </Modal.Body>
    </Modal>
